...
class EventParticipantController extends Controller
{
    ...
    public function updateParticipant(Request $request)
    {
        ...
        return redirect()->route('events.participants.update',$event_id)->with('success', 'Participante registrado exitosamente.');
    }
    ...
    public function destroy_update(EventParticipant $participant)
    {   $event_id=$participant->event_id;
        $participant->delete();

        return redirect()->route('events.participants.update',$event_id)->with('success', 'Participante borrado exitosamente.');
    }
}
