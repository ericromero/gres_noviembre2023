<x-app-layout>
    <x-slot name="header">
        ...
        <p>Desarrolladores del sistema.</p>
    </x-slot>
            ...
            <div class="grid gap-4 grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden rounded-lg shadow-sm sm:rounded-lg mb-4">
                    ...
                    <div class="p-4">
                        ...
                        <p class="text-gray-500 mb-2">Secretario Técnico de la División del Sistema Universidad Abierta de la Facultad de Psicología de la UNAM.
