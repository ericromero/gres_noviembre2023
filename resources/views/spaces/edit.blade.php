                ...
                <div class="p-6">
                    <form action="{{ route('spaces.update', $space->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" class="form-input @error('name') border-red-500 @enderror" value="{{ old('name', $space->name) }}" required>
                            @error('name')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="location" id="location" class="form-input @error('location') border-red-500 @enderror" value="{{ old('location', $space->location) }}" required>
                            @error('location')
                            <p class="text-red-500 text-sm">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="capacity" id="capacity" class="form-input @error('capacity') border-red-500 @enderror" value="{{ old('capacity', $space->capacity) }}" required>
                            @error('capacity')
                            <p class="text-red-500 text-sm">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="file" name="photography" id="photography" class="form-input @error('photography') border-red-500 @enderror">
                            @error('photography')
                            <p class="text-red-500 text-sm">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="flex justify-end">
                            <button type="submit" class="px-4 py-2 bg-blue-500 text-white font-semibold rounded-md">Actualizar Espacio</button>
                        </div>
                    </form>
                </div>
            </div>
