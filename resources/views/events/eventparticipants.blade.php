<x-app-layout>
    <x-slot name="header">
        ...
        <div class="text-gray-600 mb-2">
            <p>Si el participante es académico(a) de la Facutad de Psicología, búscalo por su número de trabajador y dando clic en "Buscar académico(a)", para ponentes externos ingresa su grado y nombre completo.</p>
        </div>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('event.searchparticipant') }}" method="POST" class="space-y-4">
                        ...
                        <div class="m-2 border-b-2 border-gray-500 ">
                            <div>
                                <label for="user_doi" class="block text-gray-700 dark:text-gray-300 font-bold mb-2">Académico(a) de la Facultad de Psicología.</label>
                                <input type="text" name="user_doi" id="user_doi" placeholder="Número de trabajador" required/>
                    ...
                    <form action="{{ route('eventparticipant.storeparticipant') }}" method="POST" class="space-y-4">
                        ...
                        <div>
                            <label for="fullname" class="block text-gray-700 dark:text-gray-300 font-bold mb-2">Grado y Nombre completo:</label>
