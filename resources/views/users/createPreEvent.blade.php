<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl leading-tight text-gray-700 dark:text-gray-300">
            {{ __('Alta de usuario')}}
        </h2>
    </x-slot>

    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 dark:bg-gray-800 text-gray-700 dark:text-gray-300 mb-2">
        ...
        <form action="{{ route('users.storePreEvent') }}" method="POST">
            ...
            <div class="mb-4">
                <label for="degree" class="block font-bold mb-2">Grado académico actual:</label>
            ...
            <div class="mb-4">
                <label for="name" class="block font-bold mb-2">Nombre completo: <span class="text-sm">(Comenzando por nombre y después apellidos).</span></label>
            ...
            <div class="mb-4">
                <select name="department" id="department" class="form-input dark:bg-gray-800 dark:text-white" required>
